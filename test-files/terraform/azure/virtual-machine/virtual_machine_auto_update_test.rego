# Rego test for Virtual Machine Auto Update
...
test_nat_gateway {
	...
	# Windows VMs
	resources["azurerm_windows_virtual_machine.bad_vm_update_config"] == false
	resources["azurerm_windows_virtual_machine.valid_vm_update_config_1"] == true
	resources["azurerm_windows_virtual_machine.valid_vm_update_config_2"] == true

	# Linux VMs
	resources["azurerm_linux_virtual_machine.bad_vm_update_config"] == false
	resources["azurerm_linux_virtual_machine.valid_vm_update_config"] == true
}

# Mock input is generated plan for virtual_machine_auto_update.tf
mock_plan_input = {
	"format_version": "0.2",
	"terraform_version": "1.0.3",
	"planned_values": {"root_module": {"resources": [
		{
			"address": "azurerm_linux_virtual_machine.bad_vm_update_config",
			"mode": "managed",
			"type": "azurerm_linux_virtual_machine",
			"name": "bad_vm_update_config",
		...
		{
			"address": "azurerm_linux_virtual_machine.valid_vm_update_config",
			"mode": "managed",
			"type": "azurerm_linux_virtual_machine",
			"name": "valid_vm_update_config",
			"provider_name": "registry.terraform.io/hashicorp/azurerm",
			"schema_version": 0,
			"values": {
				"additional_capabilities": [],
		...
		{
			"address": "azurerm_windows_virtual_machine.bad_vm_update_config",
			"mode": "managed",
		...
		{
			"address": "azurerm_windows_virtual_machine.valid_vm_update_config_1",
			"mode": "managed",
			"type": "azurerm_windows_virtual_machine",
			"name": "valid_vm_update_config_1",
			"provider_name": "registry.terraform.io/hashicorp/azurerm",
			"schema_version": 0,
			"values": {
				"additional_capabilities": [],
		...
		{
			"address": "azurerm_windows_virtual_machine.valid_vm_update_config_2",
			"mode": "managed",
			"type": "azurerm_windows_virtual_machine",
			"name": "valid_vm_update_config_2",
			"provider_name": "registry.terraform.io/hashicorp/azurerm",
			"schema_version": 0,
			"values": {
				"additional_capabilities": [],
		...
		"root_module": {"resources": [
			{
				...
				"expressions": {
					...
					"patch_mode": {"constant_value": "ImageDefault"},
			...
			},
			{
				...
				"expressions": {
					...
					"patch_mode": {"constant_value": "AutomaticByPlatform"},
					"resource_group_name": {"references": [
						"azurerm_resource_group.example.name",
						"azurerm_resource_group.example",
					]},
			...
			},
			{
				...
				"expressions": {
					...
					"admin_username": {"constant_value": "adminuser"},
					"enable_automatic_updates": {"constant_value": false},
					"location": {"references": [
						"azurerm_resource_group.example.location",
						"azurerm_resource_group.example",
					]},
			...
			},
			{
				...
				"expressions": {
					"admin_password": {"constant_value": "P@$$w0rd1234!"},
					"admin_username": {"constant_value": "adminuser"},
					"enable_automatic_updates": {"constant_value": true},
					"location": {"references": [
						"azurerm_resource_group.example.location",
						"azurerm_resource_group.example",
					]},
