# Rego test for Logic App HTTPS Requirement
# This rule denies logic app resources from being created that do not require client connections to function endpoints to leverage HTTPS
...
# Mock input is generated plan for logic_app_https_requirement.tf
mock_plan_input = {
	"format_version": "0.2",
