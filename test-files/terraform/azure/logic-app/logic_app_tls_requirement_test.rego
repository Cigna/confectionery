# Rego test for Logic App TLS Requirement
# This rule denies logic app resources from being created that do not require TLS version 1.2 or greater
...
test_https_requirement {
	...
	resources["azurerm_logic_app_standard.valid"] == true
	resources["azurerm_logic_app_standard.invalid"] == false
}

# Mock input is generated plan for logic_app_tls_requirement.tf
mock_plan_input = {
	"format_version": "0.2",
	...
	"planned_values": {"root_module": {"resources": [
		...
		{
			"address": "azurerm_logic_app_standard.invalid",
			"mode": "managed",
		...
		{
			"address": "azurerm_logic_app_standard.valid",
			"mode": "managed",
			"type": "azurerm_logic_app_standard",
			"name": "valid",
			"provider_name": "registry.terraform.io/hashicorp/azurerm",
		...
		},
		{
			...
			"change": {
				...
				"after_unknown": {
					...
					"storage_account_access_key": true,
					"storage_account_share_name": true,
				},
				"before_sensitive": false,
				"after_sensitive": {
					"app_settings": {},
		...
		"root_module": {"resources": [
			...
			},
			{
				...
				"expressions": {
					...
					"name": {"constant_value": "test-azure-functions-invalid"},
					"resource_group_name": {"references": [
						"azurerm_resource_group.example.name",
						"azurerm_resource_group.example",
					]},
			...
			},
			{
				...
				"expressions": {
					...
					"name": {"constant_value": "test-azure-functions-valid"},
					"resource_group_name": {"references": [
						"azurerm_resource_group.example.name",
						"azurerm_resource_group.example",
					]},
