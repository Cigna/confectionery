# Rego test for Functionapp TLS Requirement
# This rule denies functionapp resources from being created that do not utilize at least TLS 1.2
...
# Mock input is generated plan for functionapp_tls_requirement.tf
mock_plan_input = {
	"format_version": "0.2",
