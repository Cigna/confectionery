# Rego test for Cognitive Services Public
# Validating rule cognitive_services_public: Azure Cognitive Services should disable public network access.
...
test_public_cognitive_services {
...
# Mock input is generated plan for cognitive_services_public.tf
mock_plan_input = {
	"format_version": "0.1",
