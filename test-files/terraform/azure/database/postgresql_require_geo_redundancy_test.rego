# Rego test for PostgreSQL Require Geo Redundancy
...
test_geo_redundancy_requirement {
	...
	resources["azurerm_postgresql_server.valid"] == true
	resources["azurerm_postgresql_server.valid_basic_sku_not_compatible"] == true
	resources["azurerm_postgresql_server.invalid"] == false
}

# Mock input is generated plan for postgresql_require_geo_redundancy.tf
mock_plan_input = {
	"format_version": "0.2",
	"terraform_version": "1.0.11",
	"planned_values": {"root_module": {"resources": [
		{
			"address": "azurerm_postgresql_server.invalid",
			"mode": "managed",
		...
		{
			"address": "azurerm_postgresql_server.valid",
			"mode": "managed",
			"type": "azurerm_postgresql_server",
			"name": "valid",
			"provider_name": "registry.terraform.io/hashicorp/azurerm",
		...
		{
			"address": "azurerm_postgresql_server.valid_basic_sku_not_compatible",
			"mode": "managed",
			"type": "azurerm_postgresql_server",
		...
		"root_module": {"resources": [
			{
				...
				"expressions": {
					"administrator_login": {"constant_value": "psqladmin"},
					...
					"name": {"constant_value": "example-psqlserver-2"},
					...
					"storage_mb": {"constant_value": 640000},
					"version": {"constant_value": "9.6"},
				},
				"schema_version": 0,
			},
			{
				...
				"expressions": {
					...
					"name": {"constant_value": "example-psqlserver-1"},
					"public_network_access_enabled": {"constant_value": false},
					"resource_group_name": {"references": [
						"azurerm_resource_group.example.name",
						"azurerm_resource_group.example",
			...
			},
			{
				...
				"expressions": {
					...
					"name": {"constant_value": "example-psqlserver-3"},
					"public_network_access_enabled": {"constant_value": false},
					"resource_group_name": {"references": [
						"azurerm_resource_group.example.name",
						"azurerm_resource_group.example",
