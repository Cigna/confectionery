# Rego test for Storage Account HTTPs traffic only
# Validating rule storage_account_https: Storage Accounts should enable https traffic only.
...
test_https_sa {
	...
	resources["azurerm_storage_account.invalid_https"] == false
	resources["azurerm_storage_account.valid"] == true
}

# Mock input is generated plan for storage_account_https.tf
mock_plan_input = {
	"format_version": "0.1",
	...
	"planned_values": {"root_module": {"resources": [
		...
		{
			"address": "azurerm_storage_account.invalid_https",
			"mode": "managed",
		...
		{
			"address": "azurerm_storage_account.valid",
			"mode": "managed",
			"type": "azurerm_storage_account",
			"name": "valid",
			"provider_name": "registry.terraform.io/hashicorp/azurerm",
		...
		"root_module": {"resources": [
			...
			},
			{
				...
				"expressions": {
					...
					"allow_blob_public_access": {"constant_value": false},
					"enable_https_traffic_only": {"constant_value": false},
			...
			{
				"address": "azurerm_storage_account.invalid_public",
				"mode": "managed",
				"type": "azurerm_storage_account",
				"name": "invalid_public",
				"provider_config_key": "azurerm",
				"expressions": {
					"account_replication_type": {"constant_value": "GRS"},
					"account_tier": {"constant_value": "Standard"},
					"allow_blob_public_access": {"constant_value": true},
					"location": {"references": ["azurerm_resource_group.example"]},
					"min_tls_version": {"constant_value": "TLS1_2"},
					"name": {"constant_value": "storageaccountname"},
					"resource_group_name": {"references": ["azurerm_resource_group.example"]},
			...
			{
				"address": "azurerm_storage_account.invalid_tls",
				"mode": "managed",
				"type": "azurerm_storage_account",
				"name": "invalid_tls",
				"provider_config_key": "azurerm",
				"expressions": {
					...
					"allow_blob_public_access": {"constant_value": false},
					"location": {"references": ["azurerm_resource_group.example"]},
					"min_tls_version": {"constant_value": "TLS1_0"},
					"name": {"constant_value": "storageaccountname"},
					"resource_group_name": {"references": ["azurerm_resource_group.example"]},
					"tags": {"constant_value": {"environment": "staging"}},
				},
