# Rego test for Public Storage Account Creation
# Validating rule storage_account_public: Storage Accounts should not be made publicly accessible.
...
test_public_sa {
	...
	resources["azurerm_storage_account.invalid"] == false
	resources["azurerm_storage_account.valid"] == true
}

# Mock input is generated plan for storage_account_public.tf
mock_plan_input = {
	"format_version": "0.1",
	...
	"planned_values": {"root_module": {"resources": [
		...
		{
			"address": "azurerm_storage_account.invalid",
			"mode": "managed",
