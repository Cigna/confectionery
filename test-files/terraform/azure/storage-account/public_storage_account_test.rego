...
# Validating rule public_storage_account: Storage Accounts should not be made publicly accessible.
...
# Mock input is generated plan for public_storage_account.tf
mock_plan_input = {
	"format_version": "0.1",
