# Rego test for Storage Account TLS 1.2
# Validating rule storage_account_tls: Storage Accounts require minimum tls version of 1.2.
...
test_tls_sa {
	...
	resources["azurerm_storage_account.invalid_tls"] == false
	resources["azurerm_storage_account.valid"] == true
}

# Mock input is generated plan for storage_account_tls.tf
mock_plan_input = {
	"format_version": "0.1",
