# Rego test for RDS Auto Minor Version Upgrade
# Validating rule rds_auto_minor_version_upgrade: Deny all RDS instances with auto minor version upgrade set to false.
...
test_rds_auto_minor_version_upgrade {
	pol := policy with input as mock_input
	resources := {p.id: p.valid | pol[p]}

	resources["aws_db_instance.invalid-upgrade"] == false
	resources["aws_db_instance.valid-upgrade"] == true
}

# Mock input is generated plan for rds_auto_minor_version_upgrade.tf
mock_plan_input = {
	"format_version": "0.1",
	"terraform_version": "0.12.28",
	"planned_values": {"root_module": {"resources": [
		{
			"address": "aws_db_instance.invalid-upgrade",
			"mode": "managed",
		...
		{
			"address": "aws_db_instance.valid-upgrade",
			"mode": "managed",
			"type": "aws_db_instance",
			"name": "valid-upgrade",
			"provider_name": "aws",
