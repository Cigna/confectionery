# Rego test for RDS Encryption
# Validating rule rds_encryption: Deny RDS instances and clusters that are not encrypted.
...
test_rds_encryption {
	...
	resources["aws_db_instance.valid-encryption"] == true
	resources["aws_rds_cluster.invalid-encryption"] == false
}

# Mock input is generated plan for rds_encryption.tf
mock_plan_input = {
	"format_version": "0.1",
	"terraform_version": "0.12.28",
	"planned_values": {"root_module": {"resources": [
		{
			"address": "aws_db_instance.valid-encryption",
			"mode": "managed",
			...
			"values": {
				...
				"iops": null,
				"kms_key_id": "arn:aws:kms:us-east-1:594905313426:key/6d749788-dbdb-4e6b-ad73-eb0278614abc",
		...
		{
			"address": "aws_rds_cluster.invalid-encryption",
			"mode": "managed",
