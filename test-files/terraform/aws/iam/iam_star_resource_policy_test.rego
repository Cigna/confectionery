# Rego test for IAM Resource Star Policy
# Validating rule iam_star_resource: Deny policies that permits certain actions and uses a wildcard attribute for resource
...
# Mock input is generated plan for iam_star_resource_policy.tf
mock_plan_input = {
	"format_version": "0.1",
